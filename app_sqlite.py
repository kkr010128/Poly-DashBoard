...
def index():
    ...
    # 웬만하면 절대 경로 사용
    model_directory_path = os.path.abspath("/home/odroid/Desktop/Resource-Manager/models")
    dummy_directory_path = os.path.abspath("/home.odroid/Desktop/Resource-Manager/models_dummy")
